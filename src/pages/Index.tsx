      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">ОбщийЧат</h1>
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Место для живого общения</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            <div className="p-4 border-b border-[#202225] flex items-center justify-between">
              <h2 className="text-white font-semibold text-base">ОбщийЧат</h2>
              <Button
                variant="ghost"
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "знакомства", "юмор", "новости", "помощь"].map((channel) => (
                    <div
                      key={channel}
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Посиделки", "Игровой зал"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Добро пожаловать в ОбщийЧат!</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">ЧатБот</span>
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать в ОбщийЧат!</strong> Здесь собираются люди со всего света — общайся, знакомься и просто хорошо проводи время 🎉
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что тебя ждёт:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>💬 Тематические каналы для любых разговоров</li>
                        <li>🎮 Голосовые комнаты для живого общения</li>
                        <li>🌍 Люди из разных городов и стран</li>
                        <li>😄 Дружелюбная атмосфера без токсичности</li>
                        <li>🔔 Уведомления только о том, что важно тебе</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Всем привет! Уже месяц здесь — атмосфера огонь 🔥 Нашла кучу друзей из разных городов
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Зашёл в голосовой — народу полно, смеялись целый час 😂 Рекомендую!
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Создай аккаунт за 30 секунд — это бесплатно</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold text-sm sm:text-base">2</span>
                    </div>
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Выбери канал</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Найди тему по душе среди наших комнат</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Знакомься, смейся и просто будь собой</p>
                  </div>
                </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему ОбщийЧат?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    {
                      icon: "Zap",
                      title: "Мгновенное общение",
                      desc: "Сообщения доставляются в реальном времени",
                    },
                    {
                      icon: "Heart",
                      title: "Тёплое сообщество",
                      desc: "Дружелюбные люди и никакой токсичности",
                    },
                    {
                      icon: "Clock",
                      title: "Всегда онлайн",
                      desc: "Чат активен 24/7 в любом часовом поясе",
                    },
                    {
                      icon: "Shield",
                      title: "Безопасно",
                      desc: "Модерация и защита личных данных",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
            ...
            <div className="p-2 sm:p-4">
              <div className="bg-[#40444b] rounded-lg px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-2">
                <span className="text-[#72767d] text-xs sm:text-sm flex-1">Напиши сообщение в #общий...</span>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Кирилл", status: "В голосовом", avatar: "К", color: "from-green-500 to-teal-500" },
                  { name: "Макс", status: "В сети", avatar: "М", color: "from-orange-400 to-red-500" },
                  { name: "Лена ✨", status: "В сети", avatar: "Л", color: "from-blue-400 to-purple-500" },
                ].map((user, index) => (
